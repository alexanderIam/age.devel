<div class="hidden cm-dialog-auto-open cm-dialog-auto-size verify_window" title="{__("under_age.popup_title_check")}" value={$dialog_titlebar_close}>
    <form name="under_age_form" action="{""|fn_url}" method="post" class="cm-ajax">
        <div class="text-error lead">
            <div class="ty-control-group">
                <label class="ty-control-group__title" for="birthday">{__("under_age.birthday_date")}</label>
                <div class="controls">
